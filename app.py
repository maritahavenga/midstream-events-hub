...
# 2. Styling (Die Oorspronklike Look)
st.markdown("""<style>
...
if not df_live.empty:
    ...
    for i, r in f_df.iterrows():
        ...
        # Knoppies Logika (Kolomme F, G, H, I)
        p_l = get_clean_link(r.iloc[5])
        t_l = get_clean_link(r.iloc[6])
        c_l = get_clean_link(r.iloc[7])
        i_l = get_clean_link(r.iloc[8])

...
if not df.empty:
    ...
    with c2:
        ...
        act_opts = sorted(list({c_a(o) for o in df[m].iloc[:, 3]}))
    ...
    .btn{background:#800000;color:white!important;padding:8px 16px;border-radius:8px;text-decoration:none;font-size:0.85rem;margin:5px 8px 8px 0;display:inline-block;font-weight:500;}

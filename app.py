...
if not df.empty:
    ...
    for _, r in df.iterrows():
        ...
        res.append({'r':r, 'dt':dt_obj if pd.notnull(dt_obj) else datetime.max.replace(tzinfo=None), 'n':n.lower(), 'g':gv, 'ft':ft, 'dd':dd, 'c':cat_raw})
    ...
    for i in res:
        ...
        age = cl(r.iloc[11])
        pre = "U" if "sport" in cat_v.lower() else "Gr "

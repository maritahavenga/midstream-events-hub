...
if not df.empty:
 ...
 h="<style>.card{background:white;padding:12px;border-radius:10px;border-left:8px solid #800000;margin-bottom:10px;box-shadow:0 2px 5px rgba(0,0,0,0.1);font-family:sans-serif;}.title{color:#800000;font-weight:bold;}.btn{background:#800000;color:white!important;padding:5px 8px;border-radius:5px;text-decoration:none;font-size:0.7rem;display:inline-block;margin:5px 5px 0 0;}.nt{background:#f0f7f7;padding:6px;border-radius:5px;font-size:0.75rem;}</style>"
 for i in res:
  r,ds=i['r'],i['dd']

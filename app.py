...
def fix_text(t):
    ...
    if "Afrikaans FAL" in t or "Eerste Addissionele Taal" in t:
    ...
    # 3. Girls Vertaling
    t = re.sub(rf'\b(g|G|dogters|meisies)\b', 'Girls', t)
    return t
...
if not df.empty:
    ...
    for _, r in df.iterrows():
        try:
            ...
            # FORCEER DATUM: Lees streng as DD/MM/YYYY
            ...
            # Vertoon datum as: 11 February 2026
    ...
    for i in res:
        ...
        # Finale Tennis Fix (as die spasie nog daar is)
        full_title = re.sub(r'(U\d+)\s+([A-D])', r'\1\2', full_title)

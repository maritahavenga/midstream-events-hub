...
def format_group_final(age_val, team_val):
    ...
    try:
        ...
        valid_nums = [n for n in all_nums if len(n) < 4] # Ignoreer datums
        
        if not valid_nums:
            return combined.replace("  ", " ").strip()
        
        # Check vir reeks met koppelteken
...
st.markdown("<div style='background:#008080; color:white; text-align:center; padding:15px; font-size:1.4rem; font-weight:700; border-bottom: 5px solid #800000;'>Laerskool Midstream

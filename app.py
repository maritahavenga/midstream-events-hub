...
# 2. Styling (Stywer margins & boksies)
st.markdown("""
<style>
...
/* Verwyder ekstra wit spasie bo en onder logo */
...
.navbar img { width:100%; max-height:140px; object-fit:contain; margin:0; padding:0; }

.header { background:#008080; color:white; text-align:center; padding:15px; font-size:1.4rem; font-weight:700; margin-top:-5px; }
...
/* Maak filters korter */
.stTextInput, .stSelectbox, .stMultiSelect { margin-bottom: -10px; }

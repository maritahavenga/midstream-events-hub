...
def fix_text(t):
    ...
    # 2. Afrikaans Name Fix
    if any(x in t for x in ["Afrikaans", "FAL", "HT", "Eerste", "Addisionele"]):
...
if not df.empty:
    ...
    st.error("❌ Geen data gevind nie. Maak seker die CSV skakel is reg.")
